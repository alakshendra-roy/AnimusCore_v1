...
- **[VENDOR LEGAL ENTITY NAME]**, a [ENTITY TYPE] organized under the laws of [JURISDICTION OF INCORPORATION] ("**Animus Core**," "**Vendor**," "**we**," "**us**"); and
...
**9.2 Governing Law; Venue.** This Agreement shall be governed by the laws of **[GOVERNING JURISDICTION]**, without regard to its conflict-of-laws principles. The Parties submit to the exclusive jurisdiction of the courts located in **[VENUE]** for any dispute arising out of this Agreement.
...
| | Vendor | Customer |
|---|---|---|
| **Entity Name** | [VENDOR LEGAL ENTITY NAME] | [CUSTOMER LEGAL ENTITY NAME] |
| **Signature** | ___________________________ | ___________________________ |
| **Name** | [PRINTED NAME] | [PRINTED NAME] |
| **Title** | [TITLE] | [TITLE] |
| **Date** | [DATE] | [DATE] |
| **Notice Address** | [VENDOR ADDRESS] | [CUSTOMER ADDRESS] |
