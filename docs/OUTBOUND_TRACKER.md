...
- Batch 1 has since had one named-contact research pass (see "Contact sourcing notes — Batch 1" above) — every name found carries a real caveat (unconfirmed title, no surname, or no verified contact channel), so treat each as a lead to verify on LinkedIn before sending, not a ready-to-use contact. No email address or LinkedIn URL was fabricated for any firm above.
